...
// 	protoc        v6.32.1
// source: Protobuf/OrderService.proto
...
func (x *GetReq) Reset() {
	*x = GetReq{}
	mi := &file_Protobuf_OrderService_proto_msgTypes[0]
...
func (*GetReq) Descriptor() ([]byte, []int) {
	return file_Protobuf_OrderService_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetResp) Reset() {
	*x = GetResp{}
	mi := &file_Protobuf_OrderService_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetResp) Descriptor() ([]byte, []int) {
	return file_Protobuf_OrderService_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateReq) Reset() {
	*x = CreateReq{}
	mi := &file_Protobuf_OrderService_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateReq) Descriptor() ([]byte, []int) {
	return file_Protobuf_OrderService_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateResp) Reset() {
	*x = CreateResp{}
	mi := &file_Protobuf_OrderService_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateResp) Descriptor() ([]byte, []int) {
	return file_Protobuf_OrderService_proto_rawDescGZIP(), []int{3}
}
...
var File_Protobuf_OrderService_proto protoreflect.FileDescriptor

const file_Protobuf_OrderService_proto_rawDesc = "" +
	"\n" +
	"\x1bProtobuf/OrderService.proto\x12\borderAPI\"<\n" +
	"\x06GetReq\x12\x19\n" +
	...
	"\vCreateOrder\x12\x13.orderAPI.CreateReq\x1a\x14.orderAPI.CreateRespB\x1bZ\x19./Protobuf/order;orderAPIb\x06proto3"

var (
	file_Protobuf_OrderService_proto_rawDescOnce sync.Once
	file_Protobuf_OrderService_proto_rawDescData []byte
)

func file_Protobuf_OrderService_proto_rawDescGZIP() []byte {
	file_Protobuf_OrderService_proto_rawDescOnce.Do(func() {
		file_Protobuf_OrderService_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_Protobuf_OrderService_proto_rawDesc), len(file_Protobuf_OrderService_proto_rawDesc)))
	})
	return file_Protobuf_OrderService_proto_rawDescData
}

var file_Protobuf_OrderService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_Protobuf_OrderService_proto_goTypes = []any{
...
var file_Protobuf_OrderService_proto_depIdxs = []int32{
...
func init() { file_Protobuf_OrderService_proto_init() }
func file_Protobuf_OrderService_proto_init() {
	if File_Protobuf_OrderService_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_Protobuf_OrderService_proto_rawDesc), len(file_Protobuf_OrderService_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_Protobuf_OrderService_proto_goTypes,
		DependencyIndexes: file_Protobuf_OrderService_proto_depIdxs,
		MessageInfos:      file_Protobuf_OrderService_proto_msgTypes,
	}.Build()
	File_Protobuf_OrderService_proto = out.File
	file_Protobuf_OrderService_proto_goTypes = nil
	file_Protobuf_OrderService_proto_depIdxs = nil
}
